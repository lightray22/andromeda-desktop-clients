...
Note for FreeBSD to allow FUSE mounting by regular users, you will need to add your user to the operator group with `qpw group mod operator -m `whoami``, and enable user mounting with `sysctl vfs.usermount=1`.  
